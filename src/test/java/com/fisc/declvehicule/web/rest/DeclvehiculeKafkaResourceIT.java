...
import com.fisc.declvehicule.DeclvehiculeApp;
...
@SpringBootTest(classes = DeclvehiculeApp.class)
@DirtiesContext(classMode = DirtiesContext.ClassMode.BEFORE_CLASS)
public class DeclvehiculeKafkaResourceIT {
    ...
    @Autowired
    private DeclvehiculeKafkaProducer producer;

    @Autowired
    private DeclvehiculeKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        DeclvehiculeKafkaResource kafkaResource = new DeclvehiculeKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/declvehicule-kafka/publish?message=test"))
